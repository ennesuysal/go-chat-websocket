...
func (uc *UserCreate) SetIsOnline(i int) *UserCreate {
	uc.mutation.SetIsOnline(i)
	return uc
}
...
func (uc *UserCreate) check() error {
	...
	if _, ok := uc.mutation.Surname(); !ok {
		return &ValidationError{Name: "surname", err: errors.New("ent: missing required field \"surname\"")}
	}
	...
	if _, ok := uc.mutation.IsOnline(); !ok {
		return &ValidationError{Name: "isOnline", err: errors.New("ent: missing required field \"isOnline\"")}
	}
	return nil
}
