...
func (mq *MessageQuery) QueryOwner() *UserQuery {
...
func (mq *MessageQuery) WithOwner(opts ...func(*UserQuery)) *MessageQuery {
	query := &UserQuery{config: mq.config}
...
//		GroupBy(message.FieldSenderUsername).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
//
...
//
//	client.Message.Query().
//		Select(message.FieldSenderUsername).
//		Scan(ctx, &v)
//
